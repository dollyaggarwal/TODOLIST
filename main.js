...
function saveTasksToLocalStorage() {
    const tasks = [];
    list_el.querySelectorAll('.task').forEach(task => {
        const taskText = task.querySelector('.text').value;
        tasks.push({ content: taskText, completed: task.querySelector('input[type="checkbox"]').checked });
    });
...
function loadTasksFromLocalStorage() {
    ...
    storedTasks.forEach(task => {
        ...
        updateTaskCount(); // Ensure task count is updated after loading tasks
    });
}
